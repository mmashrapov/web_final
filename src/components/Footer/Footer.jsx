        ...
        <Row>
          ...
          <Col lg="3" md="4" sm="6">
            <div className="mb-4">
              ...
              <p className="office__info">Gagarin street 200, Almaty, Kazahstan</p>
              <p className="office__info">Phone: 8-800-555-35-35</p>

              <p className="office__info">Email: madimashrapov@gmail.com</p>
          ...
          <Col lg="12">
            <div className="footer__bottom">
              <p className="section__description d-flex align-items-center justify-content-center gap-1 pt-4">
                ...
                Mashrapov Madi. All rights reserved.
              </p>
            </div>
          </Col>
        </Row>
